...
--계정생성
CREATE USER c##hmd IDENTIFIED BY hmd1234 
    DEFAULT TABLESPACE users 
    TEMPORARY TABLESPACE temp 
    PROFILE DEFAULT;
--권한부여    
GRANT CONNECT, RESOURCE TO c##hmd; 
GRANT CREATE VIEW, CREATE SYNONYM TO c##hmd; 
GRANT UNLIMITED TABLESPACE TO c##hmd; 
--락 풀기
ALTER USER c##hmd ACCOUNT UNLOCK;
